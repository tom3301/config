...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "d",     function () awful.util.spawn_with_shell("rofi -show drun") end,
              {description = "run prompt program", group = "rofi"}),
    awful.key({ modkey },            "f",     function () awful.util.spawn_with_shell("rofi -show filebrowser") end,
              {description = "run prompt files", group = "rofi"}),
    awful.key({ modkey },            "w",     function () awful.util.spawn_with_shell("rofi -show window") end,
              {description = "run prompt window", group = "rofi"}),
    awful.key({ modkey },            "r",     function () awful.util.spawn_with_shell("rofi -show run") end,
              {description = "run prompt program", group = "rofi"}),
    awful.key({ modkey, "Shift" },            "l",     function () awful.util.spawn_with_shell("i3lock --color 778899") end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
        awful.util.spawn("brightnessctl set 5%- -n --min-value=5%") end),
...
-- }}}
awful.spawn.with_shell("feh --bg-scale ~/Pictures/wallpaper.jpeg")
